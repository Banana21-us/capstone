...
export class AddclassComponent implements OnInit {
    ...
    updateFormArray() {
        ...
        const semesterValue = this.classManagementForm.value.semester || null; // Get the semester value

        this.subjects.forEach((subject: Subject) => {
            const formGroup = this.createFormGroup(subject, semesterValue); // Pass semester value to createFormGroup
    ...
    createFormGroup(subject: Subject, semester?: number): FormGroup { // Accept semester as an optional parameter
        return this.fb.group({
            ...
            semester: [semester, Validators.nullValidator], // Add semester field here
        });
    }
        ...
        if (this.classManagementForm.valid) {
            ...
            const formValues = {
                ...
                forms: this.classManagementForm.value.forms.map((formGroup: any) => ({
                    ...
                    semester: formGroup.semester || null, // Include semester in each form submission
                })),
            };
